...
namespace ViveHandTracking
{
    ...
    public class ModelRenderer : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (colliderType == HandColliderType.Collider)
            {
                ...
                {
                    GameObject go = new GameObject("Bone" + i);
                    go.transform.parent = Hand.transform;
                    go.layer = gameObject.layer;
        ...
        private void Update()
        {
            ...
            {
                Color color = Hand.GetComponent<Renderer>().material.color;
        ...
        private void SetNodeRotation(int nodeIndex, Vector3 modelVec, Vector3 axis, Vector3 fingerNormal)
        {
            ...
            float angle = SignedAngle(Nodes[nodeIndex].rotation * localNoraml, fingerNormal, axis);
    ...
    17, 18, 18, 19, 19, 20, // pinky
        ...
        {
            Bounds bounds = new Bounds(Nodes[0].position, Vector3.zero);
        ...
        private void UpdateCollider()
        {
            ...
            {
                Vector3 start = Nodes[Bones[index++]].position;
                Vector3 end = Nodes[Bones[index++]].position;
        ...
        private void SetBounds(Transform t, Bounds b)
        {
            t.position = b.center;

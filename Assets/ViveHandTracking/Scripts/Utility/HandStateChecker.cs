...
namespace ViveHandTracking
{
    ...
    [Serializable]
    internal class HandResetCondition
    {
    ...
    [Serializable]
    internal class HandStateCondition
    {
    ...
    [Serializable]
    internal class HandStateChangeEvent : UnityEvent<int> { }

    [HelpURL("https://hub.vive.com/storage/tracking/unity/advanced.html#using-gesture-as-events")]
    internal class HandStateChecker : MonoBehaviour
    {
        ...
        private HandFlag GetCustomFlag(bool isLeft)
        {
            HandFlag flag = HandFlagNone;
            if (CustomGestureProvider.Current == null)
                return flag;

            HandFlag current = HandFlag.CustomGesture1;
            ...
            {
                BaseSingleHandGestureProducer producer = CustomGestureProvider.Current.SingleHandCustomGestures[i];
        ...
        private bool IsFlagMatch(HandFlag left, HandFlag right, HandStateCondition condition)
        {

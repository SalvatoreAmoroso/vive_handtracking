...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                foreach (WheelCollider componentsInChild in transform.GetChild(i).GetComponentsInChildren<WheelCollider>())
                {
        ...
        private void CaluclateAerodynamicEffect()
        {
            ...
            if (m_Rigidbody.velocity.magnitude > 0)
            {
                ...
                Vector3 newVelocity = Vector3.Lerp(m_Rigidbody.velocity, transform.forward * ForwardSpeed,
